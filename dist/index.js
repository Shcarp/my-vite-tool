    ...
    setup(build2) {
      build2.onResolve(
        ...
        async (loadInfo) => {
          ...
          const code = await import_fs_extra.default.readFile(entryPath, "utf8");
...
function esbuildTransformPlugin() {
  return {
    ...
    async load(id) {
      if (isJSRequest(id)) {
        try {
          return await (0, import_fs_extra2.readFile)(id, "utf8");
        } catch (e) {
          return null;
        }
      }
  ...
  return {
    ...
    async resolveId(id, importer) {
      if (import_path7.default.isAbsolute(id)) {
        ...
        let resolvedId;
        if (hasExtension) {
          resolvedId = normalizePath(import_resolve2.default.sync(id, { basedir: import_path7.default.dirname(importer) }));
